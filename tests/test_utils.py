...
from pytortilla.utils import is_valid_url,tortilla_message,get_file_size,process_files_concurrently,build_simplified_range_header
...
class TestBuildSimplifiedRangeHeaderWithDataset:
    ...
    def test_tortilla_mixed_ranges(self):
        ...
        assert build_simplified_range_header(df) == expected_header  # Check if header matches
